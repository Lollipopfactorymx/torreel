...
// Helper para verificar autenticación de Firebase
async function verifyFirebaseAuth(req: any): Promise<{ uid: string; email?: string } | null> {
...
const ALLOWED_ORIGINS = [
    'https://torre-el.web.app',
    'https://torre-el.firebaseapp.com',
