...
class Tenant extends React.Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
                                                        ...
                                                        {!!authUser.roles[ROLES.ADMIN] && (
                                                            <div className='panel-footer text-right'>
                                                                <Link to={ROUTES.ADD_TENANT} className='btn bg00'>
                                                                    <img src={addUserIcon} alt='' className='img-responsive' />
                                                                </Link>
                                                            </div>
                                                        )}
...
export default withAuthorization(condition)(withFirebase(Tenant));
